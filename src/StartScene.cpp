...
void StartScene::draw()
{
	...
	SDL_RenderDrawLine(TheGame::Instance()->getRenderer(), 100, 350, 600, 350);
...
void StartScene::start()
{
	...
	m_pShip = new Ship();
	m_pShip->setPosition(glm::vec2(100.0f, 300.0f));
	addChild(m_pShip);
}
...
void StartScene::m_updateUI()
{
	...
	if (ImGui::SliderFloat("Pixels Per Metre", &m_PPM, 1.0f, 30.0f, "%.1f"))
	{
...
void StartScene::m_move()
{
	...
	// Pfx = Pix + Vixcos(theta)T + 1/2Ax^2
	// Pfy = Piy + Viycos(theta)T + 1/2Ay^2
